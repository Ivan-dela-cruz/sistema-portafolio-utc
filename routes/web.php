...
//Visualizar los archivos y reportes actividad
    ...
    Route::get('modificar_subida_documentos', 'PeriodosController@listarPeriodoAcademico')->middleware("roleshinobi:director");
    ...
    //URLS PARA ELIMINAR LOS INSUMOS
    Route::post('eliminar-insumo/{id}', 'InsumosController@eliminarInsumo')->middleware('roleshinobi:director');
    Route::post('eliminar-insumo-create/{id}', 'InsumosController@eliminarInsumoCreate')->middleware('roleshinobi:director');
    Route::post('eliminar-insumo-pdf/{id}', 'InsumosController@eliminarInsumoPdf')->middleware('roleshinobi:director');
    Route::post('eliminar-insumo-xls/{id}', 'InsumosController@eliminarInsumoXls')->middleware('roleshinobi:director');
    Route::post('eliminar-insumo-doc/{id}', 'InsumosController@eliminarInsumoDoc')->middleware('roleshinobi:director');

    ///urls para editar los insumos
    Route::get('editar-insumo/{id}', 'InsumosController@edit')->middleware('roleshinobi:director');
    //urls para actualizar datos del insumo
    Route::post('actualizar-insumo', 'InsumosController@update')->middleware('roleshinobi:director');
    ///subir archivos  pdf insumos
    Route::post('subir-insumo-pdf', 'InsumosController@subirPDFinsumo')->middleware('roleshinobi:docente');
    ///subir archivos  pdf insumos
    Route::post('subir-insumo-doc', 'InsumosController@subirDOCinsumo')->middleware('roleshinobi:docente');
    ///subir archivos  pdf insumos
    Route::post('subir-insumo-xls', 'InsumosController@subirXLSinsumo')->middleware('roleshinobi:docente');



    ///subir archivos  pdf insumos
    Route::post('subir-insumo-pdf-create', 'InsumosController@subirPDFinsumoCreate')->middleware('roleshinobi:docente');
    ///subir archivos  pdf insumos
    Route::post('subir-insumo-doc-create', 'InsumosController@subirDOCinsumoCreate')->middleware('roleshinobi:docente');
    ///subir archivos  pdf insumos
    Route::post('subir-insumo-xls-create', 'InsumosController@subirXLSinsumoCreate')->middleware('roleshinobi:docente');


    Route::post('eliminar-insumo-pdf-create/{id}', 'InsumosController@eliminarInsumoPdf')->middleware('roleshinobi:director');
    Route::post('eliminar-insumo-xls-create/{id}', 'InsumosController@eliminarInsumoXls')->middleware('roleshinobi:director');
    Route::post('eliminar-insumo-doc-create/{id}', 'InsumosController@eliminarInsumoDoc')->middleware('roleshinobi:director');
