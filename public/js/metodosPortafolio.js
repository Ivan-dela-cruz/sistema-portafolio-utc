...
//Para guardr las insumos
function getIdPdf(idAct, nombre) {
    document.getElementById("id_insumo").value = idAct;
    document.getElementById("titulo_pdf").value = nombre;
}

//Para guardr las actividades
function getIdDoc(idAct, nombre) {
    document.getElementById("id_insumo_doc").value = idAct;
    document.getElementById("titulo_doc").value = nombre;
}

//Para guardr las actividades
function getIdXls(idAct, nombre) {
    document.getElementById("id_insumo_xls").value = idAct;
    document.getElementById("titulo_xls").value = nombre;
}

//Para guardr las actividades
function getIdInsumoEdit(idAct, nombre) {
    document.getElementById("id_insumo_edit").value = idAct;
    document.getElementById("titulo_edit").value = nombre;
}