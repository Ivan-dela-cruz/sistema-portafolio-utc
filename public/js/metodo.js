...
$(document).on("submit", ".formarchivo", function (e) {
    ...
    if (nombreform == "frm_subir_insumo_pdf") {
        var miurl = "subir-insumo-pdf";
        var divresul = "notaSubirActividad";
        rs = "subir5";
    }
    if (nombreform == "frm_subir_insumo_doc") {
        var miurl = "subir-insumo-doc";
        var divresul = "notaSubirDoc";
        rs = "subir6";
    }
    if (nombreform == "frm_subir_insumo_xls") {
        var miurl = "subir-insumo-xls";
        var divresul = "notaSubirXls";
        rs = "subir7";
    }
    ...
    $.ajax({
        ...
        success: function (rs2) {
            ...
            if (rs == "subir5") {
                $("#" + divresul + "").html(rs2.mensaje);
                $('#id-tab-mat').html(rs2.html);
                //Actualizar las actividades cuando se guarda  un nuevo  archivo pdf
                mostrarArchivo();
            }
            if (rs == "subir6") {
...
$(document).on('click', '.btn-edit-insumo', function () {
    var id = $(this).data('id-insumo');
    var url = 'editar-insumo/' + id;
    $.ajax({
        // la URL para la petición
        url: url,
        type: 'get',
...
$(document).on('click', '.btn-insumo-delete-pdf', function () {

    var id = $(this).data('id-insumo');
    var url = 'eliminar-insumo-pdf/' + id;
    ...
    swal({
        ...
        if (isConfirm) {
            ...
            swal("Eliminado!", "El Documento se ha eliminado correctamente.", "success");
        } else {
            swal("Cancelado!", "Desea cancelar la operacion", "error");
        }
    });
...
$(document).on('click', '.btn-insumo-delete-doc', function () {

    var id = $(this).data('id-insumo');
    var url = 'eliminar-insumo-doc/' + id;
...
$(document).on('click', '.btn-insumo-delete-xls', function () {

    var id = $(this).data('id-insumo');
    var url = 'eliminar-insumo-xls/' + id;
...
$(document).on('click', '.btn-insumo-delete', function () {

    var id = $(this).data('id-insumo');
    var url = 'eliminar-insumo/' + id;
