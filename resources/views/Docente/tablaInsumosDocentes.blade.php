...
<div class="id-tab">
            ...
            @if ($insumo->url_pdf!='')
                <div class="col-lg-4 text-left">
                    <span>
                        ...
                        <a title="Descargar documento" href="{{url('descarga-insumo-pdf/'.$insumo->id)}}"> {{substr($insumo->url_pdf,28)}}</a>
            ...
            @if ($insumo->url_doc!='')
                <div class="col-lg-4 text-left">
                    <span>
                        ...
                        <a title="Descargar documento" href="{{url('descarga-insumo-doc/'.$insumo->id)}}">{{substr($insumo->url_doc,28)}}</a>
                    </span>
                </div>
            @endif
            @if ($insumo->url_xls!='')
                <div class="col-lg-4 text-left">
                    <span>
                        ...
                        <a title="Descargar documento" href="{{url('descarga-insumo-xls/'.$insumo->id)}}">{{substr($insumo->url_xls,28)}}</a>
                    </span>
                </div>
            @endif
            <div class="col-lg-12 text-left">
    ...
    <!--Si no existe periodo academico registrado-->
        <h4 value="">
            No existe se encontró registros
        </h4>
    @endif
</div>
