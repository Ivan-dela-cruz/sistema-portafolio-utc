<div class="id-tab">
    @if (count($insumos))
        @foreach($insumos as $insumo)
            @if(($insumo->url_pdf =='') && ($insumo->url_xls =='') &&  ($insumo->url_doc ==''))
            @else
                ...
                @if ($insumo->url_pdf!='')
                    ...
                    <span>
                        ...
                        <a title="Descargar documento"
                           href="{{url('descarga-insumo-pdf/'.$insumo->id)}}"> {{substr($insumo->url_pdf,28)}}</a>
                    </span>
                    </div>
                ...
                @if ($insumo->url_doc!='')
                    ...
                    <span>
                        ...
                        <a title="Descargar documento"
                           href="{{url('descarga-insumo-doc/'.$insumo->id)}}">{{substr($insumo->url_doc,28)}}</a>
                    </span>
                    </div>
                @endif
                @if ($insumo->url_xls!='')
                    ...
                    <span>
                        ...
                        <a title="Descargar documento"
                           href="{{url('descarga-insumo-xls/'.$insumo->id)}}">{{substr($insumo->url_xls,28)}}</a>
                    </span>
                    </div>
                @endif
                <div class="col-lg-12 text-left">
