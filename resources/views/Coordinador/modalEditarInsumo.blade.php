...
<div class="container">
    <!-- Modal -->
    <div class="modal fade" id="modalEditarInsumo" role="dialog">
                        ...
                        <div class="col-md-10 text-center">
                            <form action="" class="formarchivo" id="frm_subir_insumo_pdf"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="id_insumo_edit" name="id_insumo_edit" type="hidden">
                                    <!--  El doque a enviar-->
                                    ...
                                    <input class="form-control" id="titulo_edit" name="titulo_edit" readonly="" required=""
                                           type="text">
                                </div>
